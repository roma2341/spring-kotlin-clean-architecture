...
dependencies {
    ...
    compileOnly("com.playtika.reactivefeign:feign-reactor-spring-cloud-starter:4.0.3")
...
tasks.getByName<BootJar>("bootJar") {
    mainClass.set("com.zigzag.crm.framework.application.ProductCatalogMicroserviceApplication")
}
